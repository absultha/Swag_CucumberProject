...
public class ProductCart {
	...
	public void user_adds_a_product_to_the_cart_something(String productname1) throws Throwable {
		WebElement add = driver.findElement(By.xpath("//div[@class='inventory_item_name' and text()='" + productname1 + "']/following::button[1]"));
		add.click();  
